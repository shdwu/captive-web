<template>
  <div class="login">
    ...
    <!-- 登陆表单 -->
    <div class="info" :style="{backgroundImage: 'url(' + infoUrl + ')' }">
      <!-- 表单 -->
      <el-form :model="loginForm" :rules="rules" ref="loginForm" label-width="70px" label-position="left"
        ...
        <el-form-item label="用户名" prop="userCode">
          <el-input type="name" v-model="loginForm.userCode"></el-input>
        </el-form-item>
        <el-form-item label="密 码" prop="password">
          <el-input type="password" v-model="loginForm.password"></el-input>
        </el-form-item>
        <el-form-item label="验证码" prop="verifyCode">
          <el-input type="verifyCode" class="mms" v-model="loginForm.verifyCode"
            @keyup.enter.native="submitForm('loginForm')"></el-input>
          <img class="fls" ref="loginForms" :src="codeUrl" @click="refreshCode">
        </el-form-item>
